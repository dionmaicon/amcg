...
class DepartamentoController extends Controller
{
    ...
    private function acesso(){
        ...
        $id = \yii::$app->user->id;
        $funcionario = \app\models\Funcionario::findIdentity($id);
        return $funcionario;
    }
    ...
    public function actionCreate()
    {
        ...
        if($this->acesso()->acesso > 0){
            return $this->render('/site/error', [
                'name' => "Acesso Negado",
                'classe' => "/departamento",
                'message' => "Você não tem os privilégios necessários para adicionar departamentos.",
            ]);
        }else{
    ...
    public function actionUpdate($id)
    {
        ...
        if($this->acesso()->acesso > 0){
            return $this->render('/site/error', [
                'name' => "Acesso Negado",
                'classe' => "/departamento",
                'message' => "Você não tem os privilégios necessários para atualizar departamentos.",
            ]);
        }else{
